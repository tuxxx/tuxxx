...
Theme for Awesome Window Manager.
Modified from Powerarrow Dark (https://github.com/copycat-killer)
...
local theme                                     = {}
theme.dir                                       = "/etc/xdg/awesome/themes/powerarrow-dark"
theme.font                                      = "xos4 Terminus 9"
theme.fg_normal                                 = "#DDDDFF"
theme.fg_focus                                  = "#7AC82E"
...
theme.volume = lain.widget.alsa({
    settings = function()
        ...
        widget:connect_signal("button::press", function(_,_,_,button)
            if (button == 1) then run_once.spawn({"pavucontrol"}) end
        end)
    end
})
...
local spr_l   = wibox.container.background(spr, theme.bg_focus)
